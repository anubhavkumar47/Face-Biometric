...
class FaceAnalyzer(private val overlay: FaceOverLay,
    ...
    private val captureInterval = 2000L  // 1-second interval per capture
                    ...
                    if (faces.isNotEmpty() && capturedFaces.size < 4) {
                        ...
                        if (currentTime - lastCaptureTime >= captureInterval) {
                            ...
                            val message = when (capturedFaces.size) {
                                ...
                                2 -> "Two more images needed"
                                3 -> "One more image needed"
